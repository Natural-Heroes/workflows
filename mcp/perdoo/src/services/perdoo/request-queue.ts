/**
 * Request Queue for Perdoo GraphQL API.
 *
 * Ensures requests are processed one at a time in FIFO order.
 * Prevents concurrent mutations from causing race conditions.
 */
