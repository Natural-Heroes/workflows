/**
 * Token Bucket Rate Limiter for Perdoo GraphQL API.
 *
 * Perdoo's rate limits are not publicly documented.
 * Using conservative defaults: 30 capacity, 3 tokens/second.
 */
...
/**
 * Creates a rate limiter with conservative Perdoo defaults.
 *
 * Perdoo rate limits are undocumented, so we use conservative values:
 * 30 capacity, 3 tokens/second refill.
 *
 * @returns TokenBucket configured for Perdoo API limits
 */
