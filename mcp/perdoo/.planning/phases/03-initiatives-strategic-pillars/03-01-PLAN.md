...
must_haves:
  truths:
    ...
    - "LLM can use initiatives naturally without understanding the key result/initiative implementation duality"
    - "LLM receives clear guidance on when to use initiatives vs key results"
  artifacts:
