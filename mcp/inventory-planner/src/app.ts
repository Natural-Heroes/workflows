/**
 * Inventory Planner MCP Application
 *
 * Express app with StreamableHTTPServerTransport for MCP communication.
 * Implements session-based architecture with in-memory session store.
 *
 * Separated from server.ts for testability (supertest needs app without listen).
 */
